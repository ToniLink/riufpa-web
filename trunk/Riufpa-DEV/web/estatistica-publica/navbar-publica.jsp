...
<div class="floating_menu">
    <ul id="side_tabs" >
        ...
        <li>
            <a href="<%= request.getContextPath()%>/Estatistica?nome=itens&publica=true">
                <fmt:message key="estatistica.menu.items"/>
            </a>
        </li>
        <li>
            <a href="<%= request.getContextPath()%>/Estatistica?nome=downloads-itens&publica=true">
                <fmt:message key="estatistica.menu.downloads"/>
            </a>
        </li>
       <%-- <li>
            <a href="<%= request.getContextPath()%>/Estatistica?nome=view-csc&publica=true">
                <fmt:message key="estatistica.menu.views"/>
            </a>
        </li>
        <li>
            <a href="<%= request.getContextPath()%>/Estatistica?nome=usuarios&publica=true">
                <fmt:message key="estatistica.menu.users"/>
            </a>
        </li>
        <li>
            <a href="<%= request.getContextPath()%>/Estatistica?nome=buscas&publica=true">
