...
var Protopass = Class.create({
    initialize : function(item, options) {
        ...
        this.item.insert({'after': "<div id=\""+this.field_name+"_text\"></div>"});
        this.item.insert({'after': "<div id=\""+this.field_name+"_bar\" style=\"margin:5px 0; height:8px; width: 0px; transition: all 0.5s ease;\"></div>"});

        this.bar = $(this.field_name + "_bar");
        this.feedback_text = $(this.field_name + "_text");

        this.bar.hide();
        this.feedback_text.hide();
